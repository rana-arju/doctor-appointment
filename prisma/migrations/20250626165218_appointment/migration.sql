...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_doctorSchedulesDoctorId_doctorSchedulesSchedu_fkey" FOREIGN KEY ("doctorSchedulesDoctorId", "doctorSchedulesScheduleId") REFERENCES "doctor_schedules"("doctorId", "scheduleId") ON DELETE SET NULL ON UPDATE CASCADE;
